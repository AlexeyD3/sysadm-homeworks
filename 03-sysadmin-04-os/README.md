...
```bash
root@ubuntu-focal:~# ps | grep sleep
  20013 pts/3    00:00:00 sleep
root@ubuntu-focal:~# nsenter --target 20013 --pid --mount
root@ubuntu-focal:/# ps
    PID TTY          TIME CMD
      1 pts/3    00:00:00 sleep
      2 pts/3    00:00:00 bash
     13 pts/3    00:00:00 ps
root@ubuntu-focal:/# 
```  
